    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="./AjouterOuv.php">Ajouter</a></li>
            <li><a class="dropdown-item" href="./MiseJour.php">Mise à jour</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="./AjouterEmp.php">Ajouter</a></li>
            <li><a class="dropdown-item" href="./MiseEmp.php">Mise à jour</a></li>
          </ul>
        </li>
            </ul>
            <form class="d-flex">
